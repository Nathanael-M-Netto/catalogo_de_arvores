...
document.addEventListener('DOMContentLoaded', function() {
    // Adicione aqui a lógica do seu arquivo footer.php, se houver
    // Ex: lógica para adicionar/remover nomes populares.
    // O script abaixo é APENAS para a funcionalidade do QR Code.
            ...
            if (arvoreId) {
                ...
                fetch(`gerar_qrcode.php?id=${arvoreId}`)
                    ...
                    .catch(error => {
                        ...
                        qrCodeContainer.innerHTML = '<p class="text-red-500 font-semibold">Não foi possível gerar o QR Code. Tente novamente.</p>';
                    });
            } else {
